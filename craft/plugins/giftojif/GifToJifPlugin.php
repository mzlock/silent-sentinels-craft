...
class GifToJifPlugin extends BasePlugin
{
    /**
    ...
    {
        return Craft::t('Translates gif to jif');
    }
    ...
    {
        return 'https://github.com/benjaminmodayil/giftojif/blob/master/README.md';
    }
    ...
    {
        return 'https://raw.githubusercontent.com/benjaminmodayil/giftojif/master/releases.json';
    }
    ...
    {
        Craft::import('plugins.giftojif.twigextensions.GifToJifTwigExtension');

        return new GifToJifTwigExtension();
    }
